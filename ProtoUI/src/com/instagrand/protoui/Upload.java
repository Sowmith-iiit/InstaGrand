...
public class Upload extends Activity {
	...
	private ArrayList<PictureItem> myPictures;
	...
	protected void onCreate(Bundle savedInstanceState) {
		if(getIntent().getExtras().getParcelable("pictureList") != null)
			myPictures = getIntent().getExtras().getParcelable("pictureList");
		else
			myPictures = new ArrayList<PictureItem>();
	...
	public void uploadPic(View v){
		...
		if (!notReady){
			...
			thePic.setPicture(Bitmap.createScaledBitmap(theImage, 200, 200, true));
			myPictures.add(thePic);
			resultData.putParcelableArrayListExtra("myPictures", myPictures);
